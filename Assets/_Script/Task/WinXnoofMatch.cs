...
public class WinXnoofMatch : AchievementBase {
    ...
    private void OnEnable() {
        DailyTaskManager.isGamewin += GameWin;
    }
    ...
    private void GameWin(bool iswin) {
        if (!iswin) {
            return;
        }
    ...
    public override void SetTaskCompletionTarget() {
        ...
        str_AchievementDescription = "Win " + currentTarget + " of Match";
