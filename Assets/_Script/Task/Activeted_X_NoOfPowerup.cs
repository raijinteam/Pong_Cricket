...
public class Activeted_X_NoOfPowerup : AchievementBase {
    ...
    private void OnEnable() {
        DailyTaskManager.ActvetedPowerup += ActvetedPowerup;
    }
    ...
    public override void SetTaskCompletionTarget() {
        ...
        str_AchievementDescription = "Activeted " + currentTarget + " of Powerup";
