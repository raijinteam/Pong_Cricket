...
public class PowerUpSpeedShot : Powerup {
    ...
    public override void ActivtedMyPowerup(AbilityType type, bool isplayer) {
        ...
        if (isplayer) {
            ...
            GameManager.Instance.CurrentGamePlayer.playerCollsion.ActivetedSpeedShotPowerUp();

        }
        else {

            GameManager.Instance.CurrentGamePlayerAI.playerCollsion.ActivetedSpeedShotPowerUp();
    ...
    public override void DeActivtedMyPowerup() {
        ...
        if (hasPlayerActivatedPowerup) {
            ...
            GameManager.Instance.CurrentGamePlayer.playerCollsion.DeActivetedSpeedShotPowerUp();
        }
        else {

            GameManager.Instance.CurrentGamePlayerAI.playerCollsion.DeActivetedSpeedShotPowerUp();
        }
    }
}
