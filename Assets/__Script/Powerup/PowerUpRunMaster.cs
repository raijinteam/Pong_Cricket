...
public class PowerUpRunMaster : Powerup {
    ...
    public override void ActivtedMyPowerup(AbilityType type, bool Isplayer) {
        ...
        if (Isplayer) {
            ...
            GameManager.Instance.CurrentGamePlayer.playerCollsion.ActivetedRunIncreased(RunIncreased);
        }
        else {
            GameManager.Instance.CurrentGamePlayerAI.playerCollsion.ActivetedRunIncreased(RunIncreased);
        }
    ...
    public override void DeActivtedMyPowerup() {
        ...
        if (hasPlayerActivePowerup) {
            GameManager.Instance.CurrentGamePlayer.playerCollsion.DeActivetedRunIncreased();
        }
        else {
            GameManager.Instance.CurrentGamePlayerAI.playerCollsion.DeActivetedRunIncreased();
        }
    }
}
