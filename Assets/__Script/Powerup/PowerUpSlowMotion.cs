...
public class PowerUpSlowMotion : Powerup {
    ...
    public override void ActivtedMyPowerup(AbilityType type, bool Isplayer) {
        ...
        if (Isplayer) {
            ...
            GameManager.Instance.CurrentGamePlayerAI.playerAi.ActivateSlowMotionPowerup(flt_PersantageOfSlowMotion);

        }
        else {

            GameManager.Instance.CurrentGamePlayer.player.ActivateSlowMotionPowerup(flt_PersantageOfSlowMotion);
    ...
    public override void DeActivtedMyPowerup() {
        ...
        if (hasPlayerActivatedPowerup) {
            ...
            GameManager.Instance.CurrentGamePlayerAI.playerAi.DeActivateSlowMotionPowerup();
        }
        else {

            GameManager.Instance.CurrentGamePlayer.player.DeActivateSlowMotionPowerup();
        }
    }
}
