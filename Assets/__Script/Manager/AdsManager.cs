...
public class AdsManager : MonoBehaviour {
    ...
    [SerializeField] private AdsRewardType currentReward;
...
# if UNITY_ANDROID
    ...
    public void ShowRewardAds(AdsRewardType _Reward) {
    ...
    private void GetRewardOfCustmer() {
        ...
        switch (currentReward) {
            case AdsRewardType.SkipTime:
                ChestManager.Instance.UserCompletedWatchAdToSkipTime();
                break;
            case AdsRewardType.Coin:
                break;
            case AdsRewardType.SkipDailyTask:
                UIManager.Instance.ui_HomeScreen.GetSkipTaskReward();
                break;
            case AdsRewardType.chestOpning:
                UIManager.Instance.ui_ChestOpping.GetAllReward2X();
                break;
            case AdsRewardType.MiniGame:
                
                GameManager.Instance.mini_GameSpawner.GetComponentInChildren<mini_GameInformation>().gameObject.SetActive(true);
                break;
            default:
                break;
        }
