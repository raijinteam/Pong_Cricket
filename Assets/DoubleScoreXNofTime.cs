...
public class DoubleScoreXNofTime : AchievementBase {

    [SerializeField] private int minimumDoubleRun;
    [SerializeField] private int maximumDoubleRun;
    [SerializeField] private int currentTarget;
    [SerializeField] private int currentProgress;


    private void OnEnable() {
        DailyTaskManager.DoubleScoreget += DoubleRunget;
    }
    ...
    public override void SetTaskCompletionTarget() {
        currentTarget = Random.Range(minimumDoubleRun, maximumDoubleRun);
        str_AchievementDescription = "Double Run " + currentTarget + " no Of Time";
